...
[X] **PLEASE COMMENT YOUR CODE.** Do not clone this repository. Instead, [X] download the zip,  [X] extract the contents, [X]`git init`, [X]`git add .`, [X]`git commit -m "initial commit - base project"` and [X]add your remote. Please do this before you leave for the day.
